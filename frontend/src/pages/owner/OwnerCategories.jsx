...
import { getAllCategories, getAllStores, createCategory, updateCategory, deleteCategory } from '../../api/businessOwnerApi';
import Button from '../../components/Button';
import Modal from '../../components/Modal';
import Input from '../../components/Input';
import './OwnerCategories.css';
...
const OwnerCategories = () => {
    ...
    const handleOpenModal = (category = null) => {
        if (category) {
            ...
            setFormData({ storeId: stores.length > 0 ? stores[0].id : '', name: '' });
        }
        setIsModalOpen(true);
    };
